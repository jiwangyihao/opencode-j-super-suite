...
| 组合 | 版本 | 状态 | 说明 |
| --- | --- | --- | --- |
| Copilot 单插件 | `opencode-copilot-account-switcher@0.15.0` | 已发布 | [GitHub](https://github.com/jiwangyihao/opencode-copilot-account-switcher) / [npm](https://www.npmjs.com/package/opencode-copilot-account-switcher)；Copilot 账号、quota、routing、retry 与 status 聚合在一个包内。 |
...
| Copilot + 远程值守 | `opencode-copilot-account-switcher@0.15.0` + `opencode-oncall@0.1.5` | 推荐组合 | 两者不应通过内部模块互相依赖。 |
