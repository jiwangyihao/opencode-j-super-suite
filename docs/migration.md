...
| 旧能力 | 新归属 | 安装命令 |
| --- | --- | --- |
| GitHub Copilot 账号、quota、routing、retry、status | `opencode-copilot-account-switcher` | `opencode plugin opencode-copilot-account-switcher@0.15.0 --force -g` |
...
1. 先升级 Copilot 包到 `opencode-copilot-account-switcher@0.15.0`。
